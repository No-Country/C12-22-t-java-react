...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-800 h-24 flex justify-beetwen items-center">
      ...
      <div className="flex  justify-center items-center ml-6">
        ...
        <NavLink href="#home" to="/" as={Link}>
          <span className="text-gray-300 hover:text-white text-xl mr-5">Home</span>
        </NavLink>
     
        <NavLink href="#mac" to="/mac" as={Link} >
          <span className="text-gray-300 hover:text-white text-xl mr-5">Mac</span>  
        </NavLink>

        <NavLink href="#iPad" to="/ipad" as={Link} className="text-white">
        <span className="text-gray-300 hover:text-white text-xl mr-5">iPad</span> 
        </NavLink>

        <NavLink href="#iPhone" to="/iphone" as={Link} className="text-white ">
        <span className="text-gray-300 hover:text-white text-xl ">iPhone</span> 
        </NavLink>
      </div>
