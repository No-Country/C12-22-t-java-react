...
const Footer = () => {
  return (
    <footer className="bg-gray-800 px-12 text-white pt-32 text-center md:text-left">
      <hr />
      <div className="flex item-center justify-center flex-wrap gap-8 md:gap-36 text-xl p-4">
        <div>
