  ...
  const addProduct = () => {
    ...
    return (
        ...
        <ul>
            {
                macbook.map(mac => (
                    <li className='border-solid  border border-gray-600 p-10 rounded-xl mt-6 mb-6'>
                        <img src={mac.imagen1}/>
                        <div className='flex justify-center align-self mt-5'>
                       <p>USD <b >{mac.precio}</b></p>
                       <i class="fa-solid fa-cart-plus ml-3 mt-1 hover:text-sky-400 " onClick={() => addProduct()}></i>
                       </div>
                    </li>
